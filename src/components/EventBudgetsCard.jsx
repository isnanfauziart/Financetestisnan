    ...
    <div className="mt-6 animate-bento-in">
      <div className="flex items-center justify-between mb-3 px-1">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-bold text-md3-on-surface-variant uppercase tracking-wider">{events.length} aktif</span>
        </div>
        ...
        {events.map((evt) => {
          ...
          return (
            <button
              ...
              className="w-full text-left bento-tile bg-md3-surface-container-lowest border border-md3-outline-variant shadow-warm p-3 rounded-2xl flex items-center gap-3 hover:bg-md3-surface-container-high transition-colors"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-md3-on-surface truncate">{evt.nama}</p>
