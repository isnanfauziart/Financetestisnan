export default function FutureForecast() {
  return (
    <section className="chapter forecast-chapter" id="prediksi" aria-labelledby="forecast-title">
      <div className="forecast-chapter__intro" data-reveal="">
      ...
      <div className="forecast-chapter__grid">
        <div className="forecast-metrics" data-reveal-group="" aria-label="Ringkasan proyeksi 90 hari">
        ...
        <div className="forecast-timeline" data-reveal="">
          ...
          <svg viewBox="0 0 720 250" role="img" aria-label="Proyeksi arus kas 90 hari" aria-describedby="forecast-chart-summary">
            ...
            <path className="forecast-timeline__line" data-draw="" d="M20 171 C112 157, 142 163, 205 145 S316 147, 365 120 S472 126, 527 91 S632 81, 700 52" />
          ...
          <ol className="forecast-milestones" data-reveal-group="">
