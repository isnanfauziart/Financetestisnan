...
async function fetchEventTransactions(accessToken, spreadsheetId, eventId) {
...
export async function GET(request, { params }) {
  ...
  try {
    ...
    // Get transactions
    const transactions = await fetchEventTransactions(accessToken, spreadsheetId, event.id)
