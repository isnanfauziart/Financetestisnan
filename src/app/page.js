      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-cream-100">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {[
              { label: "Pemasukan", value: "Rp 35,6 jt", color: "#9f87ef" },
              { label: "Pengeluaran", value: "Rp 18,3 jt", color: "#e8956d" },
              { label: "Surplus", value: "Rp 17,4 jt", color: "#5cbd8a" },
              { label: "Margin", value: "48.7%", color: "#f5a623" },
            ].map((item) => (
              <div key={item.label} className="rounded-2xl p-3" style={{ background: "#fdf8f3" }}>
